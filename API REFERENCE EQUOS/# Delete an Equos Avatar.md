...
````yaml https://api.equos.ai/docs/v1-json delete /v1/avatars/{id}
openapi: 3.0.0
info:
  title: Equos.ai API
...
paths:
  /v1/avatars/{id}:
    delete:
      tags:
        - Avatar
      summary: Delete an Equos Avatar. This action is irreversible.
      operationId: AvatarController_archive_v1
      parameters:
        - name: id
          required: true
          in: path
          description: Equos Avatar ID
          schema:
            type: string
      responses:
        '200':
