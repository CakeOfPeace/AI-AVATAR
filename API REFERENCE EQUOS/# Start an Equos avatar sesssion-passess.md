...
````yaml https://api.equos.ai/docs/v1-json post /v1/session-passes
openapi: 3.0.0
info:
  title: Equos.ai API
...
paths:
  /v1/session-passes:
    post:
      ...
      operationId: SessionPassesController_start_v1
      parameters: []
      requestBody:
        required: true
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/CreateSessionPassRequest'
      responses:
        '201':
          description: ''
          content:
  ...
  schemas:
    CreateSessionPassRequest:
      ...
      properties:
        ...
        client:
          type: string
          description: '[Optional] User-side client identifier.'
        maxDuration:
          type: number
          description: >-
            ...
            organization limit.
        avatar:
          description: Existing equos avatar ID.
          allOf:
            - $ref: '#/components/schemas/EquosResourceReference'
        agent:
          description: Existing equos agent ID.
          allOf:
            - $ref: '#/components/schemas/EquosResourceReference'
        additionalCtx:
          type: string
        ...
        consumerIdentity:
          description: >-
            Identity of the end user that will interact with the agent in the
            session.
          allOf:
