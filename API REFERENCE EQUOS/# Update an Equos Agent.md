...
````yaml https://api.equos.ai/docs/v1-json put /v1/agents/{id}
openapi: 3.0.0
info:
  title: Equos.ai API
...
paths:
  /v1/agents/{id}:
    put:
      tags:
        - Agent
      summary: Update an Equos Agent.
      operationId: AgentController_update_v1
      parameters:
        - name: id
          required: true
          in: path
      ...
      requestBody:
        ...
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/UpdateEquosAgentRequest'
      responses:
        '200':
          description: ''
          content:
