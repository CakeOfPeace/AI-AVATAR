...
````yaml https://api.equos.ai/docs/v1-json delete /v1/agents/{id}
openapi: 3.0.0
info:
  title: Equos.ai API
...
paths:
  /v1/agents/{id}:
    delete:
      tags:
        - Agent
      summary: Delete an Equos Agent. This action is irreversible.
      operationId: AgentController_archive_v1
      parameters:
        - name: id
          required: true
          in: path
